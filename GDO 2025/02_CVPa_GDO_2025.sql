...
CASE WHEN OCO.codigo_municipio IN (310690,311590,311960,312130,312738,312850,314020,314950,315010,315540,315620,316290) THEN '02 BPM'
    ...
    CAST(OCO.codigo_municipio AS INTEGER) as id_municipio,                          -- Converte o código do município para número inteiro
...
--    OCO.numero_endereco,                                          -- Número do endereço
    UPPER(OCO.nome_bairro) as name_bairro,                                             -- Nome do bairro
...
--    OCO.numero_longitude,                                        -- Longitude do local da ocorrência
    FROM_TIMESTAMP(OCO.data_hora_fato, 'dd/MM/yy') as data_fato,                                        -- Data e hora em que ocorreu o fato
