/*---------------------------------------------------------------------------------------------------------------------------
 * Script do indicador CLCG tem por finalidade avaliar a quantidade de vítimas de lesão corporal diferente de leve e fatal.
 ---------------------------------------------------------------------------------------------------------------------------*/
SELECT                                                                
...
WHERE 1=1                                                          
    ...
    AND ENV.natureza_ocorrencia_codigo IN ('B01129')  			-- Filtra naturezas específicas da ocorrência de lesão corporal
    AND ENV.condicao_fisica_codigo = '0300'
    
    -- Condição física específica (GRAVE OU INCONSCIENTE)
