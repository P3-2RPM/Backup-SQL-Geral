...
SELECT DISTINCT
    ...
    VEI.situacao_placa_descricao,					-- DESCRIÇÃO DO TIPO DE SITUAÇÃO DA PLACA
    VEI.situacao_placa_codigo,						-- DESCRIÇÃO DO TIPO DE SITUAÇÃO DA PLACA
...
CASE WHEN OCO.codigo_municipio IN (310690,311590,311960,312130,312738,312850,314020,314950,315010,315540,315620,316290) THEN '02 BPM'
		...
		/* MUNICÍPIOS COM MAIS DE 01 UEOP - 7 Munic pios*/
    ...
    UPPER(OCO.nome_bairro) as nome_bairro,
    1 as contador
...
WHERE YEAR(OCO.data_hora_fato) = 2025 						-- OCORRÊNCIAS NO ANO DE 2025
    AND OCO.relator_sigla_orgao IN ('PM', 'PC') 			-- OCORRÊNCIAS RELATADAS PELA POLÍCIA MILITAR E POLÍCIA CIVIL
    ...
    AND VEI.tipo_veiculo_codigo <> '0400' 					-- CÓDIGO ESPECÍFICO DO TIPO DE VEÍCULO EXCETO BICICLETA
    AND VEI.situacao_placa_codigo in ('1000', '0300') 		-- CÓDIGO DE ENVOLVIMENTO FURTADO (0300) OU ROUBADO (1000)
    AND OCO.natureza_ind_consumado = 'S'					-- Natureza Consumada
...
ORDER BY 1,2,4,5; -- ORDEM ALFABÉTICA E NUMÉRICA BASEADA EM NÚMERO DE OCORRÊNCIA, TIPO DE VEÍCULO E TIPO DE PRISÃO/APREENSÃO