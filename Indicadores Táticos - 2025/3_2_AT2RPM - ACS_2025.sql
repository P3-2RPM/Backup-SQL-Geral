 ...
 *  relacionadas à subtração de cargas na área da segunda região
 --------------------------------------------------------------------------------------------------------------*/
SELECT  
...
1 AS contador													-- Criar coluna com contador 1
...
AND ( 
        OCO.natureza_codigo IN ('C01157', 'C01155')  -- FILTRA PELA NATUREZA PRINCIPAL SENDO ELAS: ROUBO E FURTO
        OR OCO.natureza_secundaria1_codigo IN ('C01157', 'C01155')  -- FILTRA PELO CÓDIGO DA PRIMEIRA NATUREZA SECUNDÁRIA SENDO ELAS: ROUBO E FURTO
        OR OCO.natureza_secundaria2_codigo IN ('C01157', 'C01155')  -- FILTRA PELO CÓDIGO DA SEGUNDA NATUREZA SECUNDÁRIA SENDO ELAS: ROUBO E FURTO
        OR OCO.natureza_secundaria3_codigo IN ('C01157', 'C01155')  -- FILTRA PELO CÓDIGO DA TERCEIRA NATUREZA SECUNDÁRIA SENDO ELAS: ROUBO E FURTO
        )
