...
( 
    ...
    WHERE 1=1 -- CONDIÇÃO SEMPRE VERDADEIRA PARA FACILITAR A ADIÇÃO DE OUTRAS CONDIÇÕES
        ...
        AND YEAR(env.data_hora_fato) > 2023 -- PROMPT PARA FILTRAR PELO ANO DA DATA/HORA DO FATO
)
...
WHERE 1=1 -- CONDIÇÃO SEMPRE VERDADEIRA PARA FACILITAR A ADIÇÃO DE OUTRAS CONDIÇÕES
    ...
    AND env.natureza_ocorrencia_codigo IN ('C01155') -- FILTRA NATUREZA DA OCORRÊNCIA (ROUBO, FURTO, EXTORSÃO)
    AND (
        env.id_envolvimento IN (25,32,1097,26,27,28,872) -- VÍTIMAS
    ...
    AND YEAR(oco.data_hora_fato) > 2023 -- FILTRA PELO ANO DA DATA/HORA DO FATO
