...
SELECT 
    ...
    WHERE 1=1                                                           
        AND OCO.numero_ocorrencia = '2025-016118327-001'
),
TODOS AS(
SELECT 
    OCO.numero_ocorrencia,
...
LEFT JOIN REDS_AUDITORIA RA ON OCO.numero_ocorrencia = RA.numero_ocorrencia
