...
END AS 'TM_ORDEM',
RAT.indicador_descricao,
RAT.quantidade,
1 as contador
FROM db_bisp_reds_reporting.tb_ocorrencia AS OCO                    -- Tabela principal de ocorrências
INNER JOIN db_bisp_reds_reporting.tb_rat_produtividade_ocorrencia AS RAT    -- Join com a tabela de materiais
    ON OCO.numero_ocorrencia = RAT.numero_ocorrencia                -- Relaciona ocorrências com seus envolvidos
