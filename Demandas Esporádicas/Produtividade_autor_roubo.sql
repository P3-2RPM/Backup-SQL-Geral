...
--            )
		ENV.id_envolvimento IN(35,36,44) -- Filtra somente envolvidos classificados como autor, co-autor, suspeito
...
--	PMV.numero_individuo_sip, -- Número SIP do envolvido 
	...
	FROM_TIMESTAMP(OCO.data_hora_fato, 'dd/MM/yy') as data_fato, -- Data e hora do fato
