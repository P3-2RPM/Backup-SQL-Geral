...
QTDE_PRESOS AS (
    SELECT
        ...
        COUNT(DISTINCT CASE
            WHEN P.natureza_ocorrencia_codigo IN ('B01121') AND P.id_envolvimento IN (35, 36, 44) THEN P.numero_envolvido
        ...
        COUNT(DISTINCT CASE
            WHEN P.natureza_ocorrencia_codigo IN ('I04033','I04035' ) AND P.id_envolvimento IN (35, 36, 44) THEN P.numero_envolvido
        END) AS quantidade_presos_trafico_drogas,
        COUNT(DISTINCT CASE
            WHEN P.natureza_ocorrencia_codigo IN ('E03012','E03014','E03016' ) AND P.id_envolvimento IN (35, 36, 44) THEN P.numero_envolvido
        END) AS quantidade_presos_ilegal_armas,
        COUNT(DISTINCT CASE
...
SELECT
    ...
    COALESCE(QP.quantidade_presos_trafico_drogas, 0) AS presos_drogas_trafico,
    COALESCE(QP.quantidade_presos_ilegal_armas, 0) AS presos_porte_armas,    
