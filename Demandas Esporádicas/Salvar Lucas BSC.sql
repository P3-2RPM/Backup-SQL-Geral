...
FROM_TIMESTAMP(OCO.data_hora_fim_preenchimento,'dd/MM/yy') as 'data_registro', -- DATA DO REGISTRO
...
WHERE 1=1 
	...
	AND OCO.data_hora_fim_preenchimento < '2025-12-15 00:00:00'
	AND OCO.data_hora_fato > '2025-09-01 00:00:00'
	AND VO.placa IN ('QMV4069','QMV4070','QMV4067','QMV4068','QMV4049','QMV4048','QMV4051','QMV4050','QMV4053','QMV4052','QMV4073','QMV4074','QMV4075','QMV4076','QMV4071','QMV4072', 'QMV0652','QMV0653','QMV0655','QMV0656','QMV0665','QMV0666','QMV0667','QMV0674')  -- FILTRA PLACA DA VIATURA POLICIAL
	AND VO.descricao_tipo_viatura = 'Viatura Principal'
GROUP BY
OCO.numero_ocorrencia, 
    ...
    setor_PM,  
    OCO.unidade_responsavel_registro_nome,
    OCO.relator_matricula, -- ADICIONADO
    OCO.relator_nome, -- ADICIONADO
    OCO.historico_ocorrencia -- ADICIONADO